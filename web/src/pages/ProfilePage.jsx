      ...
      <Layout>
        <div className="flex flex-col">
          ...
          <div className="flex flex-col p-4 pb-6 m-5 rounded-md bg-white/50">
            <h4 className=" mb-2 text-2xl text-center font-bold text-green-700">Tus perfil</h4>
            <p className="mb-2 text-lg"><strong>Nombre:</strong> {user.name} </p>
            <p className="mb-2 text-lg"><strong>Apellido:</strong> {user.surname}</p>
            <p className="mb-2 text-lg"><strong>Phone:</strong> {user.phone}</p>
            <p className="mb-2 text-lg"><strong>Email:</strong> {user.email} </p>
            <button className='mb-3 text-white bg-gradient-to-l from-emerald-700 via-green-500 to-emerald-700 shadow hover:bg-pink-700 focus:ring-4 focus:outline-none focus:ring-pink-300 font-medium rounded text-md w-20 self-center mt-4 px-4 py-1 text-center'>Editar</button>
            <p className="text-center leading-tight text-pink-600">Próximamente podrás editar tus datos o eliminar tu cuenta. Si tienes alguna duda comunicate con el administrador:</p>
            <a
